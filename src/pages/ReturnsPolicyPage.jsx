  ...
  <div className='returns-policy'>
    ...
    <section className='returns-policy__section'>
      ...
      <ol className='returns-policy__steps'>
        <li>Contacta a nuestro equipo de atención al cliente a través del formulario de <a href="/contact">Contacto</a>.</li>
    ...
    <section className='returns-policy__section'>
      ...
      <p className='returns-policy__text'>
        Si tienes alguna pregunta sobre nuestra política de devoluciones, no dudes en <a href="/contact">contactarnos</a>.
      </p>
    </section>
  </div>
);
